...
const experiences = [
    {
        ...
        period: "2022-2023",
        description: "Implemented Redis as a low-latency caching layer for frequently accessed APIs",
        technologies: ["Redis", "Spring Boot", "Java", "REST APIs"],
        achievements: [
            "70% reduction in database query load",
            "Reduced average response time from 450ms to under 100ms",
            "Improved claims processing for 1M+ users",
    ...
    },
    {
        ...
        period: "2023",
        description: "Optimized database performance for healthcare microservices",
        technologies: ["PostgreSQL", "MongoDB", "Neon", "Supabase"],
        achievements: [
            ...
            <div className="container mx-auto">
                ...
                >
                    ...
                    <div className="flex flex-col gap-4">
                        <h1 className="text-4xl font-bold text-white">Database & Performance</h1>
                        <p className="text-white/60 max-w-[600px]">
                            Expert in database design, optimization, and performance tuning.
                            Specialized in both SQL and NoSQL databases, caching strategies, and performance monitoring.
                        </p>
                    </div>
